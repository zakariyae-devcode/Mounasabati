...
from  .views import RegisterView,UserDetailView,UserUpdateView,ChangePasswordView,EmailResetView,ForgotPasswordView,LogoutView,AdminDeleteUserView,AdminUpdateUserRoleView,UserView,CustomLoginView
...
urlpatterns = [
    ...
    path("user/email-reset/", EmailResetView.as_view(), name="email-reset-view"),
